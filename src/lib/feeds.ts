...
export const FEED_URLS: Record<string, string[]> = {
  ...
  nuxt: ["https://nuxt.com/blog.xml", "https://nuxt.com/blog/feed.xml", "https://nuxt.com/feed.xml"],
  ...
  vue: ["https://blog.vuejs.org/feed.xml", "https://blog.vuejs.org/atom.xml", "https://blog.vuejs.org/rss.xml"],

  // Programming
  go: ["https://go.dev/blog/feed.atom"],
  nodejs: ["https://nodejs.org/en/feed/blog.xml"],
  python: ["https://www.python.org/blogs/rss", "https://www.python.org/feeds/all.atom.xml"],
